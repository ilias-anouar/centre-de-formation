...
if (isset($_GET['Id_formation_']) && isset($_GET['id_session']) && isset($_GET['Id_apprenant_']) && isset($_GET['Id_Formateur'])) {
    ...
    $check_result = $user->check_user_session($Id_apprenant_, $conn, $id_session);
    if ($check_result) {
        ...
        <div id="layoutSidenav_nav">
            <div id="sidenavAccordion" class="sb-sidenav accordion  " style="background-color: rgb(149, 125, 173);">
                <div class="sb-sidenav-menu">
                    ...
                    <div class="sb-sidenav-menu-nested nav"><a class="nav-link" href="inscription.php"><i class="fa fa-pencil" style="padding-right: 0px;margin: 8px;margin-left: -1px;"></i>Inscriptions</a></div>
